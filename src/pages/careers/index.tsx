  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="keywords" content="Neutram, Geomatic, Engineering, Careers" />
      </Head>
      <div className=''>
        <PageHeader title='work at nge' bg={'culture.webp'} />
        <div className='py-12 md:py-24 lg:py-36'>
        <div className='container'>
          <div className="text-2xl font-bold mb-12 ">Life at Neutram Geomatic Engineering</div>
